import { SelectorGetCurrentGum, SelectorGetCurrentPigments, SelectorGetGumsSettingsCardboardWeight, SelectorGetGumsState, SelectorGetPigmentsSettingsVorekWeight, SelectorGetPigmentsState } from "../store/selectors/selectors";
