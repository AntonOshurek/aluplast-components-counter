  ...
  return (
    <header className='gums-counter-header'>
        <div className='gums-counter-header__wrap container'>
          ...
          <NavLink className='gums-counter-header__back-link' to={AppRoute.CHEMISTRY_PAGE}>
          ...
          <h1 className='gums-counter-header__title'>{ComponentsTexts.CHEMISTRY_COUNTER_PAGE_TITLE}</h1>
          <ChemistryCounterNav/>
        </div>
    </header>
  );
