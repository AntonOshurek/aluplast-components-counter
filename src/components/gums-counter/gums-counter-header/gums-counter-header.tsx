  ...
  return (
    <header className='granulates-counter-header'>
        <div className='granulates-counter-header__wrap container'>
          ...
          <NavLink to={AppRoute.GUM_PAGE} className='granulates-counter-header__back-link'>
          ...
          <h1 className='granulates-counter-header__title'>{ComponentsTexts.GUMS_COUNTER_PAGE_TITLE}</h1>
          <GumsCounterNav/>
        </div>
    </header>
  );
